...
(function(){
  var CACHE = {};
   /*
  * Make require() a closure, exposed globally by attaching it to 'this'.
  * The require() function will then be able to access the CACHE privately.
  */
  this.require = function require(apiFilename, getAgain){
      /*
      ...
      */      
      ...
      //------------------------------------------
      var exports = {};
      chain //The chain object is not needed for synch operations??
          .start(getApiString)
      ...
      function getApiString(q){
          ...
          */
          ...
          try{
              ...
              //trying to keep chrome from complaining
          }
   ...
   this.require.getValue = function getValue(key){
     return CACHE[key];
   };
})();
//===========================